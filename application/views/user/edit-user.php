...
<a href="<?=base_url('user/view')?>">View User</a>
        ...
        <div class="card-body">
        <?=form_open('user/update/', array('name'=>'form_user', 'method'=>'post'))?>
        <div class="form-group">
        <?=form_label('Name');?>
        <?=form_input(array('name'=>'name', 'class'=>'form-control', 'value'=>"$record->name",'type'=>'text', 'id'=>'name', 'placeholder'=>"Enter Your Group Name"));?>
        ...
        <?php echo form_input(array('name'=>'email', 'class'=>'form-control',  'value'=>"$record->email",'type'=>'text', 'id'=>'name', 'placeholder'=>"Enter  Email"));?>
        </div>
        ...
        <?=form_input(['type'=>'submit', 'name'=>'Add', 'value'=>'Update', 'class'=>'btn btn-warning'])?>
        <?=form_close();?>
        </div>
        <!-- /.card-body -->
        </div>
